...
### Execute the RDA
totalrda = rda(Environmental_Site_174[11:76] ~ Elevation + DO + pH + Conductivity + Salinity + Temperature + Turbidity, data = Environmental_Site_174)
summary(totalrda)
anova(totalrda, by = 'margin', permutations = 10000)
